...
This document describes how to set up your development environment to build and test Template Studio (v2), and
explains the basic mechanics of using `git`, `node`, `npm`.

### Installing Dependencies

Before you can build Template Studio (v2), you must install and configure the following dependencies on your
machine:
...
### Forking Template Studio (v2) on Github

To contribute code to Template Studio (v2), you must have a GitHub account so you can push code to your own
fork of Template Studio (v2) and open Pull Requests in the [GitHub Repository][github].

To create a Github account, follow the instructions [here][github-signup].
Afterwards, go ahead and [fork][github-forking] the
[main Template Studio (v2) repository][github].

### Building Template Studio (v2)

To build Template Studio (v2), you clone the source code repository and use lerna to build:

```shell
# Clone your Github repository:
git clone https://github.com/<github username>/template-studio-v2.git

# Go to the Template Studio (v2) directory:
...
The Template Studio v2 project uses [jsdoc][jsdoc] for all of its code
documentation.
...
version-specific documentation by simply checking out a version of Template Studio v2 and running the build.
